...
class Hat {
	...
	Hat(
	this.size,this.color,this.name,this.createdOn,this.rgbColor,this.availableSizes,this.roles,this.dictionary,this.dictionaryWithMessage,);
	...
	factory Hat.fromJson(Map<String,dynamic> json) {
			...
			(json['dictionaryWithMessage'] as Map<String, dynamic>)?.forEach((key, val) {
				...
				dictionaryWithMessageMap[key] = new Size.fromJson(val as Map<String,dynamic>);
	...
	Map<String,dynamic>toJson() {
		...
		map['dictionaryWithMessage'] = json.decode(json.encode(dictionaryWithMessage));
		return map;
	}
